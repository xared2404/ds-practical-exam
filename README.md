...
├── src/
│   └── ds_exam/            # Modular utilities (features, scenarios, explainability)
├── reports/
...
│   └── Conclusion.md
├── models/                 # Model artifacts (kept for structure)
├── outputs/
│   ├── figures/
│   └── tables/
├── docs/
│   └── exam_statement.pdf  # Original exam instructions
├── README.md
└── .gitignore
...
- Translates Q2–Q4 into a decision-oriented framework
...
📄 [Decision Sciences Practical Exam (PDF)](docs/Decision_Sciences_Practical_Exam.pdf)
